...
class ClassificationDetectTest: XCTestCase {
    ...
    private func initResult() -> ClassificationResult {
        ...
        let table1 = CourseParsedTable(
                name: "big table",
                rows: [ClassificationParsedRecod(name: "Value", value: "22"), ClassificationParsedRecod(name: "Value", value: "0")]
        )
        let table2 = CourseParsedTable(
                name: "small table",
                rows: [ClassificationParsedRecod(name: "Sparta", value: "VELKA NULA")]
        )
    ...
    public func testRowChange() {
        newRes.tables[0].rows[0] = ClassificationParsedRecod(name: "Value", value: "0")
        newRes.tables[1].rows[0] = ClassificationParsedRecod(name: "Atheny", value: "VELKA NULA")
    ...
    public func testRowAdded() {
        newRes.tables[0].rows.append(ClassificationParsedRecod(name: "Value", value: "0"))
        newRes.tables[1].rows[0] = ClassificationParsedRecod(name: "Atheny", value: "VELKA NULA")
    ...
    private func checkSecondTableChange(res: ResultChange<ClassificationParsedRecod>) {
